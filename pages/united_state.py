...
layout = html.Div([
    dcc.Location(id='us-url', refresh=False),
    dcc.Store(id='us-page-store', data=1),
    html.Div(id='us-card-layout')
])

@dash.callback(Output('us-card-layout', 'children'),
              [Input('us-url', 'pathname'), Input('us-page-store', 'data')])
...
@dash.callback(Output('us-page-store', 'data'),
